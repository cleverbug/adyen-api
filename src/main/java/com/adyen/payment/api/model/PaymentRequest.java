...
public class PaymentRequest implements Serializable {
   ...
   /**
    * @param shopperIP the shopperIP to set
    */
   ...
   /**
    * @param shopperEmail the shopperEmail to set
    */
   ...
   /**
    * @param fraudOffset the fraudOffset to set
    */
   ...
   /**
    * @param merchantOrderReference the merchantOrderReference to set
    */
   ...
   /**
    * @param shopperInteraction the shopperInteraction to set
    */
