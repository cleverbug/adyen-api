...
public class PaymentRequestBuilder {
   ...
   public interface IBuilder {
      ...
      IBuilder shopper(String email, String ip, String reference, ShopperInteraction interaction);
   ...
   private static class Builder implements IAmount, IBuilder {
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#card(com.adyen.payment.api.model.Card)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#reference(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#shopperEmail(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#shopperIP(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#shopperRefference(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#shopperInteraction(com.adyen.payment.api.model.ShopperInteraction)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#shopper(java.lang.String, java.lang.String, java.lang.String, com.adyen.payment.api.model.ShopperInteraction)
       */
      @Override
      public IBuilder shopper(String email, String ip, String reference, ShopperInteraction interaction) {
         shopperEmail(email);
         shopperIP(ip);
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IAmount#amount(com.adyen.payment.api.model.Amount)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#build()
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#fraudOffset(long)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#mcc(int)
       */
      @Override
      public IBuilder mcc(int mcc) {
         if(mcc >= 0 && mcc <= 9999) {
            ...
            // warn throw new IllegalArgumentException("invalid range: mcc: " + mcc);
         }
         return this;
      }

      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#merchantOrderReference(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#selectedBrand(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#additionalField(java.lang.String, java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#additionalFields(java.util.Map)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#browserInfo(java.lang.String, java.lang.String)
       */
      @Override
      public IBuilder browserInfo(String userAgent, String acceptHeader) {
         if(StringUtils.isNotBlank(userAgent) && StringUtils.isNotBlank(acceptHeader)) {
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#browserInfo(com.adyen.payment.api.model.BrowserInfo)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#md(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#paResponse(java.lang.String)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#billingAddress(com.adyen.payment.api.model.BillingAddress)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#additionalAmount(com.adyen.payment.api.model.Amount)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see com.adyen.payment.api.model.PaymentRequestBuilder.IBuilder#installments(int)
       */
      @Override
