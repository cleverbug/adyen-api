 ...
 * 
 * <p>Note: 'direct inspiration' from Spring/Core. Used here to avoid dependecy
 * on spring-core.</p>
 * 
...
public abstract class NestedRuntimeException extends RuntimeException {
   ...
   /**
    * Retrieve the most specific cause of this exception, that is, either the innermost cause (root cause) or this exception
    * itself.
    * <p>
   ...
   /**
    * Check whether this exception contains an exception of the given type: either it is of the given class itself or it contains
    * a nested cause of the given type.
    * 
    * @param exType
